...
/**
 * Provides the local service interface for EnrollCourse. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author mzos
 * @see EnrollCourseLocalServiceUtil
...
public interface EnrollCourseLocalService extends BaseLocalService,
	InvokableLocalService, PersistedModelLocalService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link EnrollCourseLocalServiceUtil} to access the enroll course local service. Add custom service methods to {@link com.test.service.impl.EnrollCourseLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
